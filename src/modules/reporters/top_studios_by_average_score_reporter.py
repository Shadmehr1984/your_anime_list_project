...
#extract report
query = """
CALL top_studios_by_average_score_report();
"""
...
for item in data:
    fixed_data.append((rank, item[0], item[1], item[2]))
    rank += 1
...
<head>
    ...
    <title>Your Anime List · Top Studios by Score</title>
    ...
    <style>
        ...
        * {
        ...
        .studio-table thead th:last-child,
        .studio-table tbody td:last-child {
            text-align: right;
        }
    ...
    <div class="container">
        ...
        <main>
            ...
            <p class="page-subtitle">
                Studios with the highest average product scores
            </p>
...
report_name = "top_studios_by_average_score_report.html"
